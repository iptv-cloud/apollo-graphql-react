...
function create(apiKey = TMDB_API_KEY, { retryDelay, killAfter } = { retryDelay: process.env.TMDB_DEFAULT_RETRY_DELAY || 20, killAfter: process.env.TMDB_KILL_RETRY_AFTER || 40 }) {
  if (!apiKey) {
